// package/esm/js/ExtractorData.helper.js
var DataFile = class {
  constructor(data) {
    this.buffers = [];
    this.pos = 0;
...
// package/esm/js/ExtractorData.js
...
// package/esm/js/unrar.singleton.js
var unrar;
